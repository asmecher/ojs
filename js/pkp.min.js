...
this._trigger("afterTagRemoved",null,{tag:c,tagLabel:this.tagLabel(c)})}},removeTagByLabel:function(a,b){var d=this._findTagByLabel(a);if(!d)throw"No such tag exists with the name '"+a+"'";this.removeTag(d,b)},removeAll:function(){var a=this;this._tags().each(function(b,d){a.removeTag(d,!1)})}})})(jQuery);(function(a){"function"===typeof define&&define.amd?define(["jquery"],a):a(jQuery)})(function(a){function c(a){return e.raw?a:encodeURIComponent(a)}function b(c,b){var i;if(e.raw)i=c;else a:{var j=c;0===j.indexOf('"')&&(j=j.slice(1,-1).replace(/\\"/g,'"').replace(/\\\\/g,"\\"));try{j=decodeURIComponent(j.replace(d," "))}catch(k){i=void 0;break a}try{i=e.json?JSON.parse(j):j;break a}catch(n){}i=void 0}return a.isFunction(b)?b(i):i}var d=/\+/g,e=a.cookie=function(d,h,i){if(void 0!==h&&!a.isFunction(h)){i=
a.extend({},e.defaults,i);if("number"===typeof i.expires){var j=i.expires,k=i.expires=new Date;k.setDate(k.getDate()+j)}return document.cookie=[c(d),"=",c(e.json?JSON.stringify(h):String(h)),i.expires?"; expires="+i.expires.toUTCString():"",i.path?"; path="+i.path:"",i.domain?"; domain="+i.domain:"",i.secure?"; secure":""].join("")}for(var i=d?void 0:{},j=document.cookie?document.cookie.split("; "):[],k=0,n=j.length;k<n;k++){var l=j[k].split("="),m;m=l.shift();m=e.raw?m:decodeURIComponent(m);l=l.join("=");
if(d&&d===m){i=b(l,h);break}if(!d&&void 0!==(l=b(l)))i[m]=l}return i};e.defaults={};a.removeCookie=function(c,b){return void 0!==a.cookie(c)?(a.cookie(c,"",a.extend({},b,{expires:-1})),!0):!1}});(function(a){a.fn.equalizeElementHeights=function(){var c=this.map(function(c,d){return a(d).height()}).get();return this.height(Math.max.apply(this,c))}})(jQuery);(function(a){a.fn.jLabel=function(c){function b(c){this.equals=function(a){return a.attr("id")==this.input.attr("id")};this.input=c;var b=a("label[for="+c.attr("id")+"]");0==b.size()&&(b=a("<label>").attr("for",c.attr("id")).text(c.attr("title")));c.before(b);b.css({"font-family":c.css("font-family"),"font-size":c.css("font-size"),"font-style":c.css("font-style"),"font-variant":c.css("font-variant"),"font-weight":c.css("font-weight"),"letter-spacing":c.css("letter-spacing"),"line-height":c.css("line-height"),
"text-decoration":c.css("text-decoration"),"text-transform":c.css("text-transform"),color:c.css("color"),cursor:c.css("cursor"),width:c.css("width"),display:"inline-block",overflow:"hidden"});b.mousedown(function(){return!1}).css({position:"relative","z-index":"100","margin-right":-b.width(),left:h.xShift+parseInt(c.css("padding-left"))+"px",top:h.yShift+"px"});this.label=b;""!=this.input.val()&&this.label.hide()}function d(c){var b;a.each(f,function(){if(this.equals(c))return b=this,!1});return b}
function e(a){var c=d(a).label;""==a.val()?c.stop().fadeTo(h.speed,h.opacity):c.is(":visible")&&c.stop().fadeTo(h.speed,0,function(){c.hide()})}var f=[],h=a.extend({},a.fn.jLabel.defaults,c);return this.each(function(){var c=a(this);f.push(new b(c));c.focus(function(){var c=a(this);""==c.val()&&d(c).label.stop().fadeTo(h.speed,h.opacity)}).blur(function(){var c=a(this);""==c.val()&&d(c).label.stop().fadeTo(h.speed,1)}).keyup(function(){e(a(this))}).change(function(){e(a(this))})})};a.fn.jLabel.defaults=
{speed:200,opacity:0.4,xShift:2,yShift:0}})(jQuery);jQuery&&function(a){a.extend(a.fn,{selectBox:function(c,b){var d,e="",f=navigator.platform.match(/mac/i),h=function(c,b){var d,e=function(c,b){c.children("OPTION, OPTGROUP").each(function(){if(a(this).is("OPTION"))if(0<a(this).length){var c=a(this),d=b,f=a("<li />"),g=a("<a />");f.addClass(c.attr("class"));f.data(c.data());g.attr("rel",c.val()).text(c.text());f.append(g);c.attr("disabled")&&f.addClass("selectBox-disabled");c.attr("selected")&&f.addClass("selectBox-selected");d.append(f)}else b.append("<li>\u00a0</li>");
else c=a('<li class="selectBox-optgroup" />'),c.text(a(this).attr("label")),b.append(c),b=e(a(this),b)});return b};switch(b){case "inline":return d=a('<ul class="selectBox-options" />'),d=e(c,d),d.find("A").bind("mouseover.selectBox",function(){p(c,a(this).parent())}).bind("mouseout.selectBox",function(){s(c,a(this).parent())}).bind("mousedown.selectBox",function(a){a.preventDefault();c.selectBox("control").hasClass("selectBox-active")||c.selectBox("control").focus()}).bind("mouseup.selectBox",function(b){l();
m(c,a(this).parent(),b)}),u(d),d;case "dropdown":d=a('<ul class="selectBox-dropdown-menu selectBox-options" />');d=e(c,d);d.data("selectBox-select",c).css("display","none").appendTo("BODY").find("A").bind("mousedown.selectBox",function(a){a.preventDefault();a.screenX===d.data("selectBox-down-at-x")&&a.screenY===d.data("selectBox-down-at-y")&&(d.removeData("selectBox-down-at-x").removeData("selectBox-down-at-y"),l())}).bind("mouseup.selectBox",function(b){b.screenX===d.data("selectBox-down-at-x")&&
b.screenY===d.data("selectBox-down-at-y")||(d.removeData("selectBox-down-at-x").removeData("selectBox-down-at-y"),m(c,a(this).parent()),l())}).bind("mouseover.selectBox",function(){p(c,a(this).parent())}).bind("mouseout.selectBox",function(){s(c,a(this).parent())});var f=c.attr("class")||"";if(""!==f){var f=f.split(" "),g;for(g in f)d.addClass(f[g]+"-selectBox-dropdown-menu")}u(d);return d}},i=function(c){return("selectBox-label "+(a(c).find("OPTION:selected").attr("class")||"")).replace(/\s+$/,"")},
j=function(c){return a(c).find("OPTION:selected").text()||"\u00a0"},k=function(c){var c=a(c),b=c.data("selectBox-control");b&&b.find(".selectBox-label").attr("class",i(c)).text(j(c))},n=function(c){var c=a(c),b=c.data("selectBox-control"),d=c.data("selectBox-settings"),e=b.data("selectBox-options");if(b.hasClass("selectBox-disabled"))return!1;l();var f=isNaN(b.css("borderBottomWidth"))?0:parseInt(b.css("borderBottomWidth"));e.width(b.innerWidth()).css({top:b.offset().top+b.outerHeight()-f,left:b.offset().left});
...
var g=0,h=[];c.attr("multiple")?e.find(".selectBox-selected A").each(function(){h[g++]=a(this).attr("rel")}):h=b.find("A").attr("rel");e.data("selectBox-last-selected",b);c.val()!==h&&(c.val(h),k(c),c.trigger("change"));return!0},p=function(c,b){c=a(c);b=a(b);c.data("selectBox-control").data("selectBox-options").find(".selectBox-hover").removeClass("selectBox-hover");b.addClass("selectBox-hover")},s=function(c,b){c=a(c);a(b);c.data("selectBox-control").data("selectBox-options").find(".selectBox-hover").removeClass("selectBox-hover")},
t=function(c,b,d){if(b&&0!==b.length){var c=a(c),c=c.data("selectBox-control"),e=c.data("selectBox-options"),c=c.hasClass("selectBox-dropdown")?e:e.parent(),e=parseInt(b.offset().top-c.position().top),f=parseInt(e+b.outerHeight());d?c.scrollTop(b.offset().top-c.offset().top+c.scrollTop()-c.height()/2):(0>e&&c.scrollTop(b.offset().top-c.offset().top+c.scrollTop()),f>c.height()&&c.scrollTop(b.offset().top+b.outerHeight()-c.offset().top+c.scrollTop()-c.height()))}},x=function(c,b){var c=a(c),d=c.data("selectBox-control"),
f=d.data("selectBox-options"),g=c.data("selectBox-settings"),h=0,i=0;if(!d.hasClass("selectBox-disabled"))switch(b.keyCode){case 8:b.preventDefault();e="";break;case 9:case 27:l();s(c);break;case 13:d.hasClass("selectBox-menuShowing")?(m(c,f.find("LI.selectBox-hover:first"),b),d.hasClass("selectBox-dropdown")&&l()):n(c);break;case 38:case 37:b.preventDefault();if(d.hasClass("selectBox-menuShowing")){d=f.find(".selectBox-hover").prev("LI");h=f.find("LI:not(.selectBox-optgroup)").length;for(i=0;(0===
d.length||d.hasClass("selectBox-disabled")||d.hasClass("selectBox-optgroup"))&&!(d=d.prev("LI"),0===d.length&&(d=g.loopOptions?f.find("LI:last"):f.find("LI:first")),++i>=h););p(c,d);m(c,d,b);t(c,d)}else n(c);break;case 40:case 39:if(b.preventDefault(),d.hasClass("selectBox-menuShowing")){d=f.find(".selectBox-hover").next("LI");h=f.find("LI:not(.selectBox-optgroup)").length;for(i=0;(0===d.length||d.hasClass("selectBox-disabled")||d.hasClass("selectBox-optgroup"))&&!(d=d.next("LI"),0===d.length&&(d=
g.loopOptions?f.find("LI:first"):f.find("LI:last")),++i>=h););p(c,d);m(c,d,b);t(c,d)}else n(c)}},g=function(c,b){var c=a(c),f=c.data("selectBox-control"),g=f.data("selectBox-options");if(!f.hasClass("selectBox-disabled"))switch(b.keyCode){case 9:case 27:case 13:case 38:case 37:case 40:case 39:break;default:f.hasClass("selectBox-menuShowing")||n(c),b.preventDefault(),clearTimeout(d),e+=String.fromCharCode(b.charCode||b.keyCode),g.find("A").each(function(){if(a(this).text().substr(0,e.length).toLowerCase()===
e.toLowerCase())return p(c,a(this).parent()),t(c,a(this).parent()),!1}),d=setTimeout(function(){e=""},1E3)}},u=function(c){a(c).css("MozUserSelect","none").bind("selectstart",function(a){a.preventDefault()})};switch(c){case "control":return a(this).data("selectBox-control");case "settings":if(!b)return a(this).data("selectBox-settings");a(this).each(function(){a(this).data("selectBox-settings",a.extend(!0,a(this).data("selectBox-settings"),b))});break;case "options":if(void 0===b)return a(this).data("selectBox-control").data("selectBox-options");
...
"inline",d=h(c,f),e.data("selectBox-options",d),f){case "inline":e.append(d);break;case "dropdown":k(c),a("BODY").append(d)}});break;case "value":if(void 0===b)return a(this).val();a(this).each(function(){var c,d=b;c=a(this);c.val(d);d=c.val();null===d&&(d=c.children().first().val(),c.val(d));var e=c.data("selectBox-control");if(e){var f=c.data("selectBox-settings"),e=e.data("selectBox-options");k(c);e.find(".selectBox-selected").removeClass("selectBox-selected");e.find("A").each(function(){if("object"===
...
function(a){x(b,a)}).bind("keypress.selectBox",function(a){g(b,a)}).bind("mousedown.selectBox",function(c){a(c.target).is("A.selectBox-inline")&&c.preventDefault();e.hasClass("selectBox-focus")||e.focus()}).insertAfter(b),!b[0].style.height){var f=b.attr("size")?parseInt(b.attr("size")):5,m=e.clone().removeAttr("id").css({position:"absolute",top:"-9999em"}).show().appendTo("body");m.find(".selectBox-options").html("<li><a>\u00a0</a></li>");var p=parseInt(m.find(".selectBox-options A:first").html("&nbsp;").outerHeight());
m.remove();e.height(p*f)}}else f=a('<span class="selectBox-label" />'),m=a('<span class="selectBox-arrow" />'),f.attr("class",i(b)).text(j(b)),d=h(b,"dropdown"),d.appendTo("BODY"),e.data("selectBox-options",d).addClass("selectBox-dropdown").append(f).append(m).bind("mousedown.selectBox",function(a){e.hasClass("selectBox-menuShowing")?l():(a.stopPropagation(),d.data("selectBox-down-at-x",a.screenX).data("selectBox-down-at-y",a.screenY),n(b))}).bind("keydown.selectBox",function(a){x(b,a)}).bind("keypress.selectBox",
function(a){g(b,a)}).bind("open.selectBox",function(a,c){c&&!0===c._selectBox||n(b)}).bind("close.selectBox",function(a,c){c&&!0===c._selectBox||l()}).insertAfter(b),m=e.width()-m.outerWidth()-parseInt(f.css("paddingLeft"))-parseInt(f.css("paddingLeft")),f.width(m);u(e);b.addClass("selectBox").data("selectBox-control",e).data("selectBox-settings",k).hide()}})}return a(this)}})}(jQuery);(function(){function a(a){return function(c,b,d,e){var b=u(b,e,4),f=!r(c)&&g.keys(c),h=(f||c).length,i=0<a?0:h-1;3>arguments.length&&(d=c[f?f[i]:i],i+=a);for(var j=b,k=d;0<=i&&i<h;i+=a)var l=f?f[i]:i,k=j(k,c[l],l,c);return k}}function c(a){return function(c,b,d){for(var b=q(b,d),d=v(c),e=0<a?0:d-1;0<=e&&e<d;e+=a)if(b(c[e],e,c))return e;return-1}}function b(a,c,b){return function(d,e,f){var h=0,i=v(d);if("number"==typeof f)0<a?h=0<=f?f:Math.max(f+i,h):i=0<=f?Math.min(f+1,i):f+i+1;else if(b&&f&&i)return f=
b(d,e),d[f]===e?f:-1;if(e!==e)return f=c(k.call(d,h,i),g.isNaN),0<=f?f+h:-1;for(f=0<a?h:i-1;0<=f&&f<i;f+=a)if(d[f]===e)return f;return-1}}function d(a,c){var b=H.length,d=a.constructor,d=g.isFunction(d)&&d.prototype||i,e="constructor";for(g.has(a,e)&&!g.contains(c,e)&&c.push(e);b--;)e=H[b],e in a&&(a[e]!==d[e]&&!g.contains(c,e))&&c.push(e)}var e=this,f=e._,h=Array.prototype,i=Object.prototype,j=h.push,k=h.slice,n=i.toString,l=i.hasOwnProperty,m=Array.isArray,p=Object.keys,s=Function.prototype.bind,
t=Object.create,x=function(){},g=function(a){if(a instanceof g)return a;if(!(this instanceof g))return new g(a);this._wrapped=a};"undefined"!==typeof exports?("undefined"!==typeof module&&module.exports&&(exports=module.exports=g),exports._=g):e._=g;g.VERSION="1.8.3";var u=function(a,c,b){if(void 0===c)return a;switch(null==b?3:b){case 1:return function(b){return a.call(c,b)};case 2:return function(b,d){return a.call(c,b,d)};case 3:return function(b,d,e){return a.call(c,b,d,e)};case 4:return function(b,
d,e,f){return a.call(c,b,d,e,f)}}return function(){return a.apply(c,arguments)}},q=function(a,c,b){return null==a?g.identity:g.isFunction(a)?u(a,c,b):g.isObject(a)?g.matcher(a):g.property(a)};g.iteratee=function(a,c){return q(a,c,Infinity)};var y=function(a,c){return function(b){var d=arguments.length;if(2>d||null==b)return b;for(var e=1;e<d;e++)for(var f=arguments[e],g=a(f),h=g.length,i=0;i<h;i++){var j=g[i];if(!c||void 0===b[j])b[j]=f[j]}return b}},E=function(a){if(!g.isObject(a))return{};if(t)return t(a);
x.prototype=a;a=new x;x.prototype=null;return a},z=function(a){return function(c){return null==c?void 0:c[a]}},I=Math.pow(2,53)-1,v=z("length"),r=function(a){a=v(a);return"number"==typeof a&&0<=a&&a<=I};g.each=g.forEach=function(a,c,b){var c=u(c,b),d;if(r(a)){b=0;for(d=a.length;b<d;b++)c(a[b],b,a)}else{var e=g.keys(a),b=0;for(d=e.length;b<d;b++)c(a[e[b]],e[b],a)}return a};g.map=g.collect=function(a,c,b){for(var c=q(c,b),b=!r(a)&&g.keys(a),d=(b||a).length,e=Array(d),f=0;f<d;f++){var h=b?b[f]:f;e[f]=
c(a[h],h,a)}return e};g.reduce=g.foldl=g.inject=a(1);g.reduceRight=g.foldr=a(-1);g.find=g.detect=function(a,c,b){c=r(a)?g.findIndex(a,c,b):g.findKey(a,c,b);if(void 0!==c&&-1!==c)return a[c]};g.filter=g.select=function(a,c,b){var d=[],c=q(c,b);g.each(a,function(a,b,e){c(a,b,e)&&d.push(a)});return d};g.reject=function(a,c,b){return g.filter(a,g.negate(q(c)),b)};g.every=g.all=function(a,c,b){for(var c=q(c,b),b=!r(a)&&g.keys(a),d=(b||a).length,e=0;e<d;e++){var f=b?b[e]:e;if(!c(a[f],f,a))return!1}return!0};
g.some=g.any=function(a,c,b){for(var c=q(c,b),b=!r(a)&&g.keys(a),d=(b||a).length,e=0;e<d;e++){var f=b?b[e]:e;if(c(a[f],f,a))return!0}return!1};g.contains=g.includes=g.include=function(a,c,b,d){r(a)||(a=g.values(a));if("number"!=typeof b||d)b=0;return 0<=g.indexOf(a,c,b)};g.invoke=function(a,c){var b=k.call(arguments,2),d=g.isFunction(c);return g.map(a,function(a){var e=d?c:a[c];return null==e?e:e.apply(a,b)})};g.pluck=function(a,c){return g.map(a,g.property(c))};g.where=function(a,c){return g.filter(a,
g.matcher(c))};g.findWhere=function(a,c){return g.find(a,g.matcher(c))};g.max=function(a,c,b){var d=-Infinity,e=-Infinity,f;if(null==c&&null!=a)for(var a=r(a)?a:g.values(a),h=0,i=a.length;h<i;h++)b=a[h],b>d&&(d=b);else c=q(c,b),g.each(a,function(a,b,J){f=c(a,b,J);if(f>e||-Infinity===f&&-Infinity===d)d=a,e=f});return d};g.min=function(a,c,b){var d=Infinity,e=Infinity,f;if(null==c&&null!=a)for(var a=r(a)?a:g.values(a),h=0,i=a.length;h<i;h++)b=a[h],b<d&&(d=b);else c=q(c,b),g.each(a,function(a,b,g){f=
c(a,b,g);if(f<e||Infinity===f&&Infinity===d)d=a,e=f});return d};g.shuffle=function(a){for(var a=r(a)?a:g.values(a),c=a.length,b=Array(c),d=0,e;d<c;d++)e=g.random(0,d),e!==d&&(b[d]=b[e]),b[e]=a[d];return b};g.sample=function(a,c,b){return null==c||b?(r(a)||(a=g.values(a)),a[g.random(a.length-1)]):g.shuffle(a).slice(0,Math.max(0,c))};g.sortBy=function(a,c,b){c=q(c,b);return g.pluck(g.map(a,function(a,b,d){return{value:a,index:b,criteria:c(a,b,d)}}).sort(function(a,c){var b=a.criteria,d=c.criteria;if(b!==
d){if(b>d||void 0===b)return 1;if(b<d||void 0===d)return-1}return a.index-c.index}),"value")};var A=function(a){return function(c,b,d){var e={},b=q(b,d);g.each(c,function(d,f){var g=b(d,f,c);a(e,d,g)});return e}};g.groupBy=A(function(a,c,b){g.has(a,b)?a[b].push(c):a[b]=[c]});g.indexBy=A(function(a,c,b){a[b]=c});g.countBy=A(function(a,c,b){g.has(a,b)?a[b]++:a[b]=1});g.toArray=function(a){return!a?[]:g.isArray(a)?k.call(a):r(a)?g.map(a,g.identity):g.values(a)};g.size=function(a){return null==a?0:r(a)?
a.length:g.keys(a).length};g.partition=function(a,c,b){var c=q(c,b),d=[],e=[];g.each(a,function(a,b,f){(c(a,b,f)?d:e).push(a)});return[d,e]};g.first=g.head=g.take=function(a,c,b){return null==a?void 0:null==c||b?a[0]:g.initial(a,a.length-c)};g.initial=function(a,c,b){return k.call(a,0,Math.max(0,a.length-(null==c||b?1:c)))};g.last=function(a,c,b){return null==a?void 0:null==c||b?a[a.length-1]:g.rest(a,Math.max(0,a.length-c))};g.rest=g.tail=g.drop=function(a,c,b){return k.call(a,null==c||b?1:c)};g.compact=
function(a){return g.filter(a,g.identity)};var w=function(a,c,b,d){for(var e=[],f=0,d=d||0,h=v(a);d<h;d++){var i=a[d];if(r(i)&&(g.isArray(i)||g.isArguments(i))){c||(i=w(i,c,b));var j=0,k=i.length;for(e.length+=k;j<k;)e[f++]=i[j++]}else b||(e[f++]=i)}return e};g.flatten=function(a,c){return w(a,c,!1)};g.without=function(a){return g.difference(a,k.call(arguments,1))};g.uniq=g.unique=function(a,c,b,d){g.isBoolean(c)||(d=b,b=c,c=!1);null!=b&&(b=q(b,d));for(var d=[],e=[],f=0,h=v(a);f<h;f++){var i=a[f],
j=b?b(i,f,a):i;c?((!f||e!==j)&&d.push(i),e=j):b?g.contains(e,j)||(e.push(j),d.push(i)):g.contains(d,i)||d.push(i)}return d};g.union=function(){return g.uniq(w(arguments,!0,!0))};g.intersection=function(a){for(var c=[],b=arguments.length,d=0,e=v(a);d<e;d++){var f=a[d];if(!g.contains(c,f)){for(var h=1;h<b&&g.contains(arguments[h],f);h++);h===b&&c.push(f)}}return c};g.difference=function(a){var c=w(arguments,!0,!0,1);return g.filter(a,function(a){return!g.contains(c,a)})};g.zip=function(){return g.unzip(arguments)};
g.unzip=function(a){for(var c=a&&g.max(a,v).length||0,b=Array(c),d=0;d<c;d++)b[d]=g.pluck(a,d);return b};g.object=function(a,c){for(var b={},d=0,e=v(a);d<e;d++)c?b[a[d]]=c[d]:b[a[d][0]]=a[d][1];return b};g.findIndex=c(1);g.findLastIndex=c(-1);g.sortedIndex=function(a,c,b,d){for(var b=q(b,d,1),c=b(c),d=0,e=v(a);d<e;){var f=Math.floor((d+e)/2);b(a[f])<c?d=f+1:e=f}return d};g.indexOf=b(1,g.findIndex,g.sortedIndex);g.lastIndexOf=b(-1,g.findLastIndex);g.range=function(a,c,b){null==c&&(c=a||0,a=0);for(var b=
b||1,c=Math.max(Math.ceil((c-a)/b),0),d=Array(c),e=0;e<c;e++,a+=b)d[e]=a;return d};var F=function(a,c,b,d,e){if(!(d instanceof c))return a.apply(b,e);c=E(a.prototype);a=a.apply(c,e);return g.isObject(a)?a:c};g.bind=function(a,c){if(s&&a.bind===s)return s.apply(a,k.call(arguments,1));if(!g.isFunction(a))throw new TypeError("Bind must be called on a function");var b=k.call(arguments,2),d=function(){return F(a,d,c,this,b.concat(k.call(arguments)))};return d};g.partial=function(a){var c=k.call(arguments,
...
{};return b};g.delay=function(a,c){var b=k.call(arguments,2);return setTimeout(function(){return a.apply(null,b)},c)};g.defer=g.partial(g.delay,g,1);g.throttle=function(a,c,b){var d,e,f,h=null,i=0;b||(b={});var j=function(){i=!1===b.leading?0:g.now();h=null;f=a.apply(d,e);h||(d=e=null)};return function(){var k=g.now();!i&&!1===b.leading&&(i=k);var l=c-(k-i);d=this;e=arguments;0>=l||l>c?(h&&(clearTimeout(h),h=null),i=k,f=a.apply(d,e),h||(d=e=null)):!h&&!1!==b.trailing&&(h=setTimeout(j,l));return f}};
g.debounce=function(a,c,b){var d,e,f,h,i,j=function(){var k=g.now()-h;k<c&&0<=k?d=setTimeout(j,c-k):(d=null,b||(i=a.apply(f,e),d||(f=e=null)))};return function(){f=this;e=arguments;h=g.now();var k=b&&!d;d||(d=setTimeout(j,c));k&&(i=a.apply(f,e),f=e=null);return i}};g.wrap=function(a,c){return g.partial(c,a)};g.negate=function(a){return function(){return!a.apply(this,arguments)}};g.compose=function(){var a=arguments,c=a.length-1;return function(){for(var b=c,d=a[c].apply(this,arguments);b--;)d=a[b].call(this,
d);return d}};g.after=function(a,c){return function(){if(1>--a)return c.apply(this,arguments)}};g.before=function(a,c){var b;return function(){0<--a&&(b=c.apply(this,arguments));1>=a&&(c=null);return b}};g.once=g.partial(g.before,2);var G=!{toString:null}.propertyIsEnumerable("toString"),H="valueOf isPrototypeOf toString propertyIsEnumerable hasOwnProperty toLocaleString".split(" ");g.keys=function(a){if(!g.isObject(a))return[];if(p)return p(a);var c=[],b;for(b in a)g.has(a,b)&&c.push(b);G&&d(a,c);
return c};g.allKeys=function(a){if(!g.isObject(a))return[];var c=[],b;for(b in a)c.push(b);G&&d(a,c);return c};g.values=function(a){for(var c=g.keys(a),b=c.length,d=Array(b),e=0;e<b;e++)d[e]=a[c[e]];return d};g.mapObject=function(a,c,b){for(var c=q(c,b),b=g.keys(a),d=b.length,e={},f,h=0;h<d;h++)f=b[h],e[f]=c(a[f],f,a);return e};g.pairs=function(a){for(var c=g.keys(a),b=c.length,d=Array(b),e=0;e<b;e++)d[e]=[c[e],a[c[e]]];return d};g.invert=function(a){for(var c={},b=g.keys(a),d=0,e=b.length;d<e;d++)c[a[b[d]]]=
b[d];return c};g.functions=g.methods=function(a){var c=[],b;for(b in a)g.isFunction(a[b])&&c.push(b);return c.sort()};g.extend=y(g.allKeys);g.extendOwn=g.assign=y(g.keys);g.findKey=function(a,c,b){for(var c=q(c,b),b=g.keys(a),d,e=0,f=b.length;e<f;e++)if(d=b[e],c(a[d],d,a))return d};g.pick=function(a,c,b){var d={},e=a,f,h;if(null==e)return d;g.isFunction(c)?(h=g.allKeys(e),f=u(c,b)):(h=w(arguments,!1,!1,1),f=function(a,c,b){return c in b},e=Object(e));for(var i=0,j=h.length;i<j;i++){var k=h[i],l=e[k];
f(l,k,e)&&(d[k]=l)}return d};g.omit=function(a,c,b){if(g.isFunction(c))c=g.negate(c);else var d=g.map(w(arguments,!1,!1,1),String),c=function(a,c){return!g.contains(d,c)};return g.pick(a,c,b)};g.defaults=y(g.allKeys,!0);g.create=function(a,c){var b=E(a);c&&g.extendOwn(b,c);return b};g.clone=function(a){return!g.isObject(a)?a:g.isArray(a)?a.slice():g.extend({},a)};g.tap=function(a,c){c(a);return a};g.isMatch=function(a,c){var b=g.keys(c),d=b.length;if(null==a)return!d;for(var e=Object(a),f=0;f<d;f++){var h=
b[f];if(c[h]!==e[h]||!(h in e))return!1}return!0};var B=function(a,c,b,d){if(a===c)return 0!==a||1/a===1/c;if(null==a||null==c)return a===c;a instanceof g&&(a=a._wrapped);c instanceof g&&(c=c._wrapped);var e=n.call(a);if(e!==n.call(c))return!1;switch(e){case "[object RegExp]":case "[object String]":return""+a===""+c;case "[object Number]":return+a!==+a?+c!==+c:0===+a?1/+a===1/c:+a===+c;case "[object Date]":case "[object Boolean]":return+a===+c}e="[object Array]"===e;if(!e){if("object"!=typeof a||
"object"!=typeof c)return!1;var f=a.constructor,h=c.constructor;if(f!==h&&(!g.isFunction(f)||!(f instanceof f&&g.isFunction(h)&&h instanceof h))&&"constructor"in a&&"constructor"in c)return!1}b=b||[];d=d||[];for(f=b.length;f--;)if(b[f]===a)return d[f]===c;b.push(a);d.push(c);if(e){f=a.length;if(f!==c.length)return!1;for(;f--;)if(!B(a[f],c[f],b,d))return!1}else{e=g.keys(a);f=e.length;if(g.keys(c).length!==f)return!1;for(;f--;)if(h=e[f],!g.has(c,h)||!B(a[h],c[h],b,d))return!1}b.pop();d.pop();return!0};
g.isEqual=function(a,c){return B(a,c)};g.isEmpty=function(a){return null==a?!0:r(a)&&(g.isArray(a)||g.isString(a)||g.isArguments(a))?0===a.length:0===g.keys(a).length};g.isElement=function(a){return!!(a&&1===a.nodeType)};g.isArray=m||function(a){return"[object Array]"===n.call(a)};g.isObject=function(a){var c=typeof a;return"function"===c||"object"===c&&!!a};g.each("Arguments Function String Number Date RegExp Error".split(" "),function(a){g["is"+a]=function(c){return n.call(c)==="[object "+a+"]"}});
...
l.call(a,c)};g.noConflict=function(){e._=f;return this};g.identity=function(a){return a};g.constant=function(a){return function(){return a}};g.noop=function(){};g.property=z;g.propertyOf=function(a){return null==a?function(){}:function(c){return a[c]}};g.matcher=g.matches=function(a){a=g.extendOwn({},a);return function(c){return g.isMatch(c,a)}};g.times=function(a,c,b){for(var d=Array(Math.max(0,a)),c=u(c,b,1),b=0;b<a;b++)d[b]=c(b);return d};g.random=function(a,c){null==c&&(c=a,a=0);return a+Math.floor(Math.random()*
(c-a+1))};g.now=Date.now||function(){return(new Date).getTime()};m={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#x27;","`":"&#x60;"};y=g.invert(m);z=function(a){var c=function(c){return a[c]},b="(?:"+g.keys(a).join("|")+")",d=RegExp(b),e=RegExp(b,"g");return function(a){a=null==a?"":""+a;return d.test(a)?a.replace(e,c):a}};g.escape=z(m);g.unescape=z(y);g.result=function(a,c,b){c=null==a?void 0:a[c];void 0===c&&(c=b);return g.isFunction(c)?c.call(a):c};var K=0;g.uniqueId=function(a){var c=
++K+"";return a?a+c:c};g.templateSettings={evaluate:/<%([\s\S]+?)%>/g,interpolate:/<%=([\s\S]+?)%>/g,escape:/<%-([\s\S]+?)%>/g};var C=/(.)^/,L={"'":"'","\\":"\\","\r":"r","\n":"n","\u2028":"u2028","\u2029":"u2029"},M=/\\|'|\r|\n|\u2028|\u2029/g,N=function(a){return"\\"+L[a]};g.template=function(a,c,b){!c&&b&&(c=b);var c=g.defaults({},c,g.templateSettings),b=RegExp([(c.escape||C).source,(c.interpolate||C).source,(c.evaluate||C).source].join("|")+"|$","g"),d=0,e="__p+='";a.replace(b,function(c,b,f,
g,h){e+=a.slice(d,h).replace(M,N);d=h+c.length;b?e+="'+\n((__t=("+b+"))==null?'':_.escape(__t))+\n'":f?e+="'+\n((__t=("+f+"))==null?'':__t)+\n'":g&&(e+="';\n"+g+"\n__p+='");return c});e+="';\n";c.variable||(e="with(obj||{}){\n"+e+"}\n");e="var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};\n"+e+"return __p;\n";try{var f=new Function(c.variable||"obj","_",e)}catch(h){throw h.source=e,h;}b=function(a){return f.call(this,a,g)};b.source="function("+(c.variable||"obj")+
"){\n"+e+"}";return b};g.chain=function(a){a=g(a);a._chain=!0;return a};var D=function(a,c){return a._chain?g(c).chain():c};g.mixin=function(a){g.each(g.functions(a),function(c){var b=g[c]=a[c];g.prototype[c]=function(){var a=[this._wrapped];j.apply(a,arguments);return D(this,b.apply(g,a))}})};g.mixin(g);g.each("pop push reverse shift sort splice unshift".split(" "),function(a){var c=h[a];g.prototype[a]=function(){var b=this._wrapped;c.apply(b,arguments);("shift"===a||"splice"===a)&&0===b.length&&
delete b[0];return D(this,b)}});g.each(["concat","join","slice"],function(a){var c=h[a];g.prototype[a]=function(){return D(this,c.apply(this._wrapped,arguments))}});g.prototype.value=function(){return this._wrapped};g.prototype.valueOf=g.prototype.toJSON=g.prototype.value;g.prototype.toString=function(){return""+this._wrapped};"function"===typeof define&&define.amd&&define("underscore",[],function(){return g})}).call(this);(function(a){a.pkp=a.pkp||{};a.pkp.classes=a.pkp.classes||{};a.pkp.controllers=a.pkp.controllers||{};a.pkp.plugins=a.pkp.plugins||{};a.pkp.plugins.blocks=a.pkp.plugins.blocks||{};a.pkp.plugins.generic=a.pkp.plugins.generic||{};a.pkp.plugins.pubIds=a.pkp.plugins.pubIds||{};a.pkp.plugins.importexport=a.pkp.plugins.importexport||{};a.pkp.classes.Helper=function(){throw Error("Trying to instantiate the Helper singleton!");};a.pkp.classes.Helper.CHARS_="0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz".split("");
...
a.pkp.classes.Handler.prototype.getHtmlElement=function(){a.pkp.classes.Handler.checkContext_(this);return this.$htmlElement_};a.pkp.classes.Handler.prototype.publishChangeEvents=function(){var a;for(a=0;a<this.publishChangeEvents_.length;a++)this.trigger(this.publishChangeEvents_[a])};a.pkp.classes.Handler.prototype.handleEvent=function(c){var b,d,e,f,h,i;b=a(this);d=a.pkp.classes.Handler.getHandler(b);if(b[0]!==d.getHtmlElement.call(d)[0])throw Error("An invalid handler is bound to the calling element of an event!");
b=d.eventBindings_[c.type];if(void 0===b)return!1;e=a.makeArray(arguments);f=!0;e.unshift(this);h=0;for(i=b.length;h<i&&!(!1===b[h].apply(d,e)&&(f=!1),c.isImmediatePropagationStopped());h++);c.stopPropagation();return f};a.pkp.classes.Handler.prototype.callbackWrapper=function(c,b){a.pkp.classes.Handler.checkContext_(this);b||(b=this);return function(){var d;d=a.makeArray(arguments);d.unshift(this);return c.apply(b,d)}};a.pkp.classes.Handler.prototype.remoteResponse=function(a,b){return this.handleJson(b)};
...
this.$linkActionElement.focus();this.$modal_.remove();return this.parent("finish")}})(jQuery);(function(a){a.pkp.classes.notification=a.pkp.classes.notification||{};a.pkp.classes.notification.NotificationHelper=function(){};a.pkp.classes.notification.NotificationHelper.redirectNotifyUserEvent=function(c,b){var d,e,f,h,i,j,k,n,l,m,p;if(void 0!==b.content)c.getHtmlElement().parent().trigger("notifyUser",[b]);else{d=c.getHtmlElement();e=!1;!(c instanceof a.pkp.controllers.SiteHandler)&&0<a(b).parents(".pkp_controllers_grid").length&&(d.parent().trigger("notifyUser"),e=!0);d=a(".pkp_notification",
d);f=[];h=0;for(i=d.length;h<i;h++)if(k=a(d[h]),!(0<k.parents(":hidden").length)){j=k.parents();l=0;for(m=j.length;l<m;l++)if(n=a(j[l]).data("pkp.handler"),n instanceof a.pkp.classes.Handler){p=a(j[l]);break}if(p.has(b[0]).length||p[0]===b[0]){if(0<k.parents(".ui-accordion:first").length&&(j=k.parents(".ui-accordion:first"),!j.has(b[0])))continue;f.push(k)}}if(f.length)for(h=f.length-1;-1<h;h--)f[h].triggerHandler("notifyUser");else e||c.getHtmlElement().parent().trigger("notifyUser")}}})(jQuery);(function(a){a.pkp.classes.features=a.pkp.classes.features||{};a.pkp.classes.features.Feature=function(a,b){this.gridHandler=a;this.options_=b;this.addFeatureHtml(this.getGridHtmlElement(),b)};a.pkp.classes.features.Feature.prototype.gridHandler=null;a.pkp.classes.features.Feature.prototype.options_=null;a.pkp.classes.features.Feature.prototype.setOptions=function(a){this.options_=a};a.pkp.classes.features.Feature.prototype.getOptions=function(){return this.options_};a.pkp.classes.features.Feature.prototype.init=
...
f=this.gridHandler.callbackWrapper(this.dragStartCallback,this),h=this.gridHandler.callbackWrapper(this.dragStopCallback,this),i=this.gridHandler.callbackWrapper(this.updateOrderCallback,this),b={disabled:!e,items:b,activate:f,deactivate:h,update:i,tolerance:"pointer"};"object"===typeof d&&(b=a.extend(!0,b,d));c.sortable(b)};a.pkp.classes.features.OrderItemsFeature.prototype.getRowsDataId=function(c){var b,d=[],e;for(b in this.itemsOrder)e=a("#"+this.itemsOrder[b],c),1>e.length||(e=this.gridHandler.getRowDataId(e),
...
e)||e.push(f);return e}})(jQuery);(function(a){a.pkp.classes.features.OrderListbuilderItemsFeature=function(a,b){this.parent(a,b)};a.pkp.classes.Helper.inherits(a.pkp.classes.features.OrderListbuilderItemsFeature,a.pkp.classes.features.OrderItemsFeature);a.pkp.classes.features.OrderListbuilderItemsFeature.prototype.addFeatureHtml=function(c,b){var d,e,f,h,i,j;this.parent("addFeatureHtml",c,b);d=this.getSequenceInput_();e=this.gridHandler.getRows();f=0;for(h=e.length;f<h;f++)i=a(e[f]),j=d.clone(),a("td.first_column",i).append(j)};
...
function(a){a.children().after(this.getSequenceInput_());a=this.gridHandler.getRows();this.storeOrder(a)}})(jQuery);(function(a){a.pkp.classes.features.OrderMultipleListsItemsFeature=function(a,b){this.parent(a,b)};a.pkp.classes.Helper.inherits(a.pkp.classes.features.OrderMultipleListsItemsFeature,a.pkp.classes.features.OrderListbuilderItemsFeature);a.pkp.classes.features.OrderMultipleListsItemsFeature.prototype.addFeatureHtml=function(c,b){var d,e,f,h,i,j,k;this.parent("addFeatureHtml",c,b);d=a('<input type="hidden" name="newRowId[listId]" class="itemList" />');e=this.gridHandler.getRows();f=0;for(h=e.length;f<
h;f++)i=a(e[f]),j=this.gridHandler.getListIdByRow(i),k=d.clone(),k.attr("value",j),a("td.first_column",i).append(k)};a.pkp.classes.features.OrderMultipleListsItemsFeature.prototype.storeRowOrder=function(a,b){var d,e;this.parent("storeRowOrder",a,b);d=b.find(".itemList");e=this.gridHandler.getListIdByRow(b);d.attr("value",e)};a.pkp.classes.features.OrderMultipleListsItemsFeature.prototype.setupSortablePlugin=function(){var a=this.gridHandler.getLists().find("tbody");this.applySortPlgOnElements(a,
...
void 0!=c.newTopRow&&(b=this.gridHandler.getRows(),d.currentItemsPerPage==b.length&&this.gridHandler.deleteElement(b.last(),!0),b=c.newTopRow,this.gridHandler.insertOrReplaceElement(b,!0));return!1};a.pkp.classes.features.PagingFeature.prototype.configPagingLinks_=function(){var c,b,d,e,f,h,i,j;c=this.getOptions();if(b=a("div.gridPaging",this.getGridHtmlElement())){j=this.callbackWrapper(function(b,d){h=RegExp("[?&]"+c.pageParamName+"(?:=([^&]*))?","i");i=h.exec(a(d.target).attr("href"));null!=i&&
(c.currentPage=parseInt(i[1],10),this.getGridHtmlElement().trigger("dataChanged"));return!1},this);b=b.find("a").not(".showMoreItems").not(".showLessItems");d=0;for(e=b.length;d<e;d++)f=a(b[d]),f.click(j)}};a.pkp.classes.features.PagingFeature.prototype.configItemsPerPageElement_=function(){var c,b,d,e,f,h;c=this.getOptions();if(b=a("div.gridPaging",this.getGridHtmlElement()))if(h=this.callbackWrapper(function(b,d){c.currentItemsPerPage=parseInt(a("option",d.target).filter(":selected").attr("value"),
...
function(){if("undefined"!==typeof tinyMCE){tinyMCE.PluginManager.load("jbimages",a.pkp.app.baseUrl+"/plugins/generic/tinymce/plugins/justboil.me/plugin.js");tinyMCE.PluginManager.load("pkpTags",a.pkp.app.baseUrl+"/plugins/generic/tinymce/plugins/pkpTags/plugin.js");tinyMCE.PluginManager.load("pkpwordcount",a.pkp.app.baseUrl+"/plugins/generic/tinymce/plugins/pkpWordcount/plugin.js");var c;c={width:"100%",resize:"both",entity_encoding:"raw",plugins:"paste,fullscreen,link,lists,code,-jbimages,-pkpTags,noneditable",
convert_urls:!1,forced_root_block:"p",paste_auto_cleanup_on_paste:!0,apply_source_formatting:!1,theme:"modern",toolbar:"copy paste | bold italic underline | link unlink code fullscreen | jbimages | pkpTags",richToolbar:"copy paste | bold italic underline | bullist numlist | superscript subscript | link unlink code fullscreen | jbimages | pkpTags",statusbar:!1,content_css:a.pkp.app.baseUrl+"/plugins/generic/tinymce/styles/content.css"};c="undefined"!==typeof a.pkp.plugins.tinymceplugin&&typeof a.pkp.plugins.tinymceplugin.tinymceParams?
a.extend({},c,a.pkp.plugins.tinymceplugin.tinymceParams):a.extend({},c);c.init_instance_callback=a.pkp.controllers.SiteHandler.prototype.triggerTinyMCEInitialized;c.setup=a.pkp.controllers.SiteHandler.prototype.triggerTinyMCESetup;tinyMCE.init(c)}};a.pkp.controllers.SiteHandler.prototype.triggerTinyMCEInitialized=function(c){a("#"+a.pkp.classes.Helper.escapeJQuerySelector(c.id)).trigger("tinyMCEInitialized",[c])};a.pkp.controllers.SiteHandler.prototype.triggerTinyMCESetup=function(c){var b=a("#"+
a.pkp.classes.Helper.escapeJQuerySelector(c.id));b.attr("readonly")&&(c.settings.readonly=!0);b.attr("wordCount")&&0<b.attr("wordCount")&&(c.settings.plugins+=",pkpwordcount",c.settings.statusbar=!0);b=b.attr("rows")||10;c.settings.height=(20*b).toString()+"px";c.on("init",function(c){var b=a("#"+c.id),f,h;f=a("#"+c.id).attr("placeholder");""!==f&&(h=a("<span></span>"),h.html(f),h.addClass("mcePlaceholder"),h.attr("id","mcePlaceholder-"+c.id),c.target.getContent().length&&h.hide(),c=a("<div></div>"),
c.addClass("mcePlaceholderParent"),b.wrap(c),b.parent().append(h))});c.on("activate",function(c){a("#mcePlaceholder-"+c.id).hide()});c.on("deactivate",function(c){c.target.getContent().length||a("#mcePlaceholder-"+c.id).show();c.target.dom.addClass(c.target.dom.select("li"),"show")});c.on("BeforeSetContent",function(b){var e=a.pkp.classes.TinyMCEHelper.prototype.getVariableMap("#"+a.pkp.classes.Helper.escapeJQuerySelector(c.id));b.content=b.content.replace(/\{\$([a-zA-Z]+)\}(?![^<]*>)/g,function(b,
d){return void 0!==e[d]?a.pkp.classes.TinyMCEHelper.prototype.getVariableElement(d,e[d],"#"+c.id).html():b})});c.on("SaveContent",function(c){var b=a("<div>"+c.content+"</div>");b.find(".pkpTag").replaceWith(function(){return"{$"+a(this).attr("data-symbolic")+"}"});c.content=b.html()});c.on("FullscreenStateChanged init",function(c){var c=c.target,b=a(c.editorContainer);c.plugins.fullscreen&&(c.plugins.fullscreen.isFullscreen()?b.find(".mce-toolbar[role='menubar']").show():b.find(".mce-toolbar[role='menubar']").hide())})};
...
a)for(d in a[b])new PNotify(a[b][d])};a.pkp.controllers.SiteHandler.prototype.openModal_=function(){this.getHtmlElement().addClass("modal_is_visible")};a.pkp.controllers.SiteHandler.prototype.closeModal_=function(){var a=this.getHtmlElement();a.find(".pkp_modal.is_visible").length||a.removeClass("modal_is_visible")};a.pkp.controllers.SiteHandler.prototype.registerScrollingObserver_=function(c,b,d,e){a(document).scroll(e);return!1};a.pkp.controllers.SiteHandler.prototype.unregisterScrollingObserver_=
function(c,b,d,e){a(document).unbind("scroll",e);return!1}})(jQuery);(function(a){a.pkp.controllers.UrlInDivHandler=function(a,b){this.parent(a,b);this.sourceUrl_=b.sourceUrl;this.reload();b.refreshOn&&this.bindGlobal(b.refreshOn,this.reload)};a.pkp.classes.Helper.inherits(a.pkp.controllers.UrlInDivHandler,a.pkp.classes.Handler);a.pkp.controllers.UrlInDivHandler.sourceUrl_=null;a.pkp.controllers.UrlInDivHandler.prototype.reload=function(){a.get(this.sourceUrl_,this.callbackWrapper(this.handleLoadedContent_),"json")};a.pkp.controllers.UrlInDivHandler.prototype.getSourceUrl=
...
d.split("#")[1];e=c.find("li a");for(f=0;f<e.length;f++)d==e[f].getAttribute("name")&&(b.selected=f)}c.tabs({ajaxOptions:{dataType:"json",cache:!1,dataFilter:this.callbackWrapper(this.dataFilter)},disabled:b.disabled,active:b.selected});c.children(".ui-tabs-nav").find("li > a").focus(function(){a(this).click()})};a.pkp.classes.Helper.inherits(a.pkp.controllers.TabHandler,a.pkp.classes.Handler);a.pkp.controllers.TabHandler.prototype.$currentTab_=null;a.pkp.controllers.TabHandler.prototype.currentTabIndex_=
...
null;a.pkp.controllers.NotificationHandler.prototype.fetchNotificationHandler_=function(){var c={};c.requestOptions=this.options_.requestOptions;a.ajax({type:"POST",url:this.options_.fetchNotificationUrl,data:c,success:this.callbackWrapper(this.showNotificationResponseHandler_),dataType:"json",async:!1})};a.pkp.controllers.NotificationHandler.prototype.showNotificationResponseHandler_=function(c,b){clearTimeout(this.trivialTimer_);var d=this.getHtmlElement(),e=this.handleJson(b),f,h,i;if(!1!==e)if(e.content.inPlace){f=
this.concatenateNotifications_(e.content.inPlace);h=this.removeAlreadyShownNotifications_(e);this.unbindPartial(d);d.html(f);d.show();e=this.getTrivialNotifications_(e.content.inPlace);if(!this.visibleWithoutScrolling_()&&h)for(i in d.parent().trigger("notifyUser",[h]),e)d=e[i],d=a("#pkp_notification_"+d,this.getHtmlElement()),this.unbindPartial(d),d.remove();0===d.children().length?d.hide():this.addTimerToNotifications(e)}else this.unbindPartial(this.getHtmlElement()),this.getHtmlElement().empty(),
...
"']");a(c).is(":checked")?a(b).prop("disabled",!1):a(b).prop("disabled",!0);return!0};a.pkp.controllers.form.FormHandler.prototype.tinyMCEInitHandler_=function(c,b,d){var e=d.id;d.on("blur",this.callbackWrapper(function(c){c.save();var c=this.getHtmlElement(),b=a("#"+a.pkp.classes.Helper.escapeJQuerySelector(e),c);c.validate().element(b)}))};a.pkp.controllers.form.FormHandler.prototype.containerCloseHandler=function(c,b,d){a(this.getHtmlElement()).find(".hasDatepicker").datepicker("hide");if(this.formChangesTracked)if(confirm(a.pkp.locale.form_dataHasChanged))this.trigger("unregisterAllForms");
...
null),"json")):this.enableControls(),this.callFeaturesHook("addElement",d));return!1};a.pkp.controllers.listbuilder.ListbuilderHandler.prototype.fetchOptionsResponseHandler_=function(c,b){var d=this.handleJson(b),e=this.getHtmlElement(),f=[],h,i,j,k,n,l,m,p,s,t;if(!1!==d){e.find(".gridCellDisplay :input").each(function(c,b){f[c]=a(b).val()});e=e.find(".gridRowEdit:visible .selectMenu:input");h=0;for(i=e.length;h<i;h++){j=a(e[h]);k=j.parents(".gridCellContainer");n=0;j.children().empty();l=null;for(l in d.content[h])if(l!=
a.pkp.cons.LISTBUILDER_OPTGROUP_LABEL)if("object"==typeof d.content[h][l]){if(void 0!==d.content[h][a.pkp.cons.LISTBUILDER_OPTGROUP_LABEL]&&"object"==typeof d.content[h][a.pkp.cons.LISTBUILDER_OPTGROUP_LABEL]&&(p=d.content[h][a.pkp.cons.LISTBUILDER_OPTGROUP_LABEL][l])){s=a("<optgroup></optgroup>");s.attr("label",p);j.append(s);p=null;t=0;for(p in d.content[h][l])if(m=this.populatePulldown_(s,f,d.content[h][l][p],p))n++,t++;0===t&&s.remove()}}else(m=this.populatePulldown_(j,f,d.content[h][l],l))&&
n++;j=m;1===n&&j&&(j.attr("selected","selected"),this.availableOptions_=!1);0===n&&(k.find(".gridCellDisplay").show(),k.find(".gridCellEdit").hide())}}this.enableControls();return!1};a.pkp.controllers.listbuilder.ListbuilderHandler.prototype.populatePulldown_=function(c,b,d,e){var f=c.parents(".gridCellContainer").find(".gridCellDisplay :input").val(),h=!1,i;if(e!=f)for(i=0;i<b.length;i++)b[i]==e&&(h=!0);if(h)return!1;b=a("<option/>");b.attr("value",e);b.text(d);e==f&&b.attr("selected","selected");
...
this.options.canClose&&c.append('<a href="#" class="close pkpModalCloseButton"><span class="pkp_screen_reader">'+this.options.closeButtonText+"</span></a>");c.append('<div class="content"></div>');c.attr("role","dialog").attr("aria-label",this.options.title);return c};a.pkp.controllers.modal.ModalHandler.prototype.modalOpen=function(c){a("body").append(c);setTimeout(function(){c.addClass("is_visible")},10);setTimeout(function(){c.focus()},300);c.trigger("pkpModalOpen",[c])};a.pkp.controllers.modal.ModalHandler.prototype.modalClose=
function(){var a=this,b=this.getHtmlElement(),d=b.find("form").first(),e;if(1==d.length&&(e={closePermitted:!0},d.trigger("containerClose",[e]),!e.closePermitted))return!1;b.removeClass("is_visible");this.trigger("pkpModalClose");setTimeout(function(){a.unbindPartial(b);b.empty();a.remove();"function"===typeof a.options.closeCallback&&a.options.closeCallback.call()},300);return!1};a.pkp.controllers.modal.ModalHandler.prototype.handleWrapperEvents=function(c,b){"click"==b.type&&c==b.target?a.pkp.classes.Handler.getHandler(a(c)).modalClose():
"keyup"==b.type&&27==b.which&&a.pkp.classes.Handler.getHandler(a(c)).modalClose()};a.pkp.controllers.modal.ModalHandler.prototype.redirectNotifyUserEventHandler_=function(c,b,d){a.pkp.classes.notification.NotificationHelper.redirectNotifyUserEvent(this,d)}})(jQuery);(function(a){a.pkp.controllers.modal.ConfirmationModalHandler=function(a,b){this.parent(a,b);this.callback_=b.callback||null;this.callbackArgs_=b.callbackArgs||null;a.find(".pkpModalConfirmButton").on("click",this.callbackWrapper(this.modalConfirm))};a.pkp.classes.Helper.inherits(a.pkp.controllers.modal.ConfirmationModalHandler,a.pkp.controllers.modal.ModalHandler);a.pkp.controllers.modal.ConfirmationModalHandler.prototype.callback_=null;a.pkp.controllers.modal.ConfirmationModalHandler.prototype.callbackArgs_=
null;a.pkp.controllers.modal.ConfirmationModalHandler.prototype.checkOptions=function(a){return!this.parent("checkOptions",a)?!1:"string"===typeof a.okButton&&(!1===a.cancelButton||"string"===typeof a.cancelButton)&&"string"===typeof a.dialogText};a.pkp.controllers.modal.ConfirmationModalHandler.prototype.modalBuild=function(){var a=this.parent("modalBuild"),b='<a href="#" class="ok pkpModalConfirmButton">'+this.options.okButton+"</a>";a.addClass("pkp_modal_confirmation").find(".content").append('<div class="message">'+
...
a.get(this.fetchNoteFormUrl_,this.callbackWrapper(this.showFetchedNoteForm_),"json")};a.pkp.controllers.grid.queries.ReadQueryHandler.prototype.showFetchedNoteForm_=function(c,b){var d=this.handleJson(b),e=a("#newNotePlaceholder",this.getHtmlElement()),f=a(".openNoteForm.is_loading",this.getHtmlElement());this.unbindPartial(f);f.remove();this.unbindPartial(e);e.html(d.content)};a.pkp.controllers.grid.queries.ReadQueryHandler.prototype.showFetchedParticipantsList_=function(c,b){var d=this.handleJson(b),
...
null;a.pkp.controllers.grid.settings.roles.form.UserGroupFormHandler.prototype.changeRoleId=function(c){c=a(c).val();this.updatePermitSelfRegistration(c);this.updateStageOptions(c);this.updateRecommendOnly(c)};a.pkp.controllers.grid.settings.roles.form.UserGroupFormHandler.prototype.updatePermitSelfRegistration=function(c){var b=a('[id^="permitSelfRegistration"]');this.getHtmlElement();var d,e=!1;for(d=0;d<this.selfRegistrationRoleIds_.length;d++)this.selfRegistrationRoleIds_[d]==c&&(e=!0);e?b.removeAttr("disabled"):
(b.attr("disabled","disabled"),b.removeAttr("checked"))};a.pkp.controllers.grid.settings.roles.form.UserGroupFormHandler.prototype.updateStageOptions=function(c){var b=this.getHtmlElement(),d=b.find("#userGroupStageContainer"),e=a(this.stagesSelector_,b).filter("input"),f,h=null;e.removeAttr("disabled");if(void 0!=this.roleForbiddenStages_[c])for(f=0;f<this.roleForbiddenStages_[c].length;f++)h=this.roleForbiddenStages_[c][f],e.filter('input[value="'+h+'"]').attr("disabled","disabled");0==b.find("input[id^='assignedStages-']:enabled").length?
(d.hide("slow"),a("#showTitle").attr("disabled","disabled")):(d.show("slow"),a("#showTitle").removeAttr("disabled"))};a.pkp.controllers.grid.settings.roles.form.UserGroupFormHandler.prototype.updateRecommendOnly=function(c){var b=a("[id^='recommendOnly']",this.getHtmlElement()),d,e=!1;for(d=0;d<this.recommendOnlyRoleIds_.length;d++)this.recommendOnlyRoleIds_[d]==c&&(e=!0);e?b.removeAttr("disabled"):(b.attr("disabled","disabled"),b.removeAttr("checked"))}})(jQuery);(function(a){a.pkp.controllers.grid.settings.metadata=a.pkp.controllers.grid.settings.metadata||{};a.pkp.controllers.grid.settings.metadata.MetadataGridHandler=function(a,b){a.find(":checkbox").change(this.callbackWrapper(this.checkboxHandler_));this.parent(a,b)};a.pkp.classes.Helper.inherits(a.pkp.controllers.grid.settings.metadata.MetadataGridHandler,a.pkp.controllers.grid.GridHandler);a.pkp.controllers.grid.settings.metadata.MetadataGridHandler.prototype.initialize=function(c){this.parent("initialize",
c);a(this.getHtmlElement()).find(":checkbox").change()};a.pkp.controllers.grid.settings.metadata.MetadataGridHandler.prototype.checkboxHandler_=function(c){c=a(c);c.is(":checked");var b=a(this.getHtmlElement());c.prop("name");this.getRows().each(function(){var c=a(this).prop("id").split("-").pop(),e=b.find(":checkbox[name="+c+"EnabledWorkflow]"),f=b.find(":checkbox[name="+c+"EnabledSubmission]"),c=b.find(":checkbox[name="+c+"Required]");(f.prop("checked")||c.prop("checked"))&&e.prop("checked",!0);
e.prop("readonly",f.prop("checked")||c.prop("checked"));c.prop("checked")&&f.prop("checked",!0);f.prop("readonly",c.prop("checked"))});return!1}})(jQuery);(function(a){a.pkp.controllers.tab=a.pkp.controllers.tab||{settings:{form:{}}};a.pkp.controllers.tab.settings.form.FileViewFormHandler=function(a,b){this.parent(a,b);this.fetchFileUrl_=b.fetchFileUrl;this.bind("dataChanged",this.refreshForm_)};a.pkp.classes.Helper.inherits(a.pkp.controllers.tab.settings.form.FileViewFormHandler,a.pkp.controllers.form.AjaxFormHandler);a.pkp.controllers.tab.settings.form.FileViewFormHandler.prototype.fetchFileUrl_=null;a.pkp.controllers.tab.settings.form.FileViewFormHandler.prototype.refreshForm_=
function(c,b,d){a.get(this.fetchFileUrl_,{settingName:d},this.callbackWrapper(this.refreshResponseHandler_),"json")};a.pkp.controllers.tab.settings.form.FileViewFormHandler.prototype.refreshResponseHandler_=function(a,b){var d,e=this.handleJson(b);e.noData?(d=this.getFileHtmlElement_(e.noData),this.unbindPartial(d),d.empty()):(d=this.getFileHtmlElement_(e.elementId),this.unbindPartial(d),d.html(e.content))};a.pkp.controllers.tab.settings.form.FileViewFormHandler.prototype.getFileHtmlElement_=function(c){var b=
this.getHtmlElement();return a("#"+c,b)}})(jQuery);(function(a){a.pkp.controllers.tab.settings.announcements=a.pkp.controllers.tab.settings.announcements||{form:{}};a.pkp.controllers.tab.settings.announcements.form.AnnouncementSettingsFormHandler=function(c,b){this.parent(c,b);a("#enableAnnouncementsHomepage",c).click(this.callbackWrapper(this.toggleEnableAnnouncementsHomepage))};a.pkp.classes.Helper.inherits(a.pkp.controllers.tab.settings.announcements.form.AnnouncementSettingsFormHandler,a.pkp.controllers.form.AjaxFormHandler);a.pkp.controllers.tab.settings.announcements.form.AnnouncementSettingsFormHandler.prototype.toggleEnableAnnouncementsHomepage=
function(){var c=a("#numAnnouncementsHomepage",this.getHtmlElement());c.attr("disabled")?c.removeAttr("disabled"):c.attr("disabled","disabled")}})(jQuery);(function(a){a.pkp.controllers.tab.settings.archiving=a.pkp.controllers.tab.settings.archiving||{form:{}};a.pkp.controllers.tab.settings.archiving.form.ArchivingSettingsFormHandler=function(c,b){this.parent(c,b);a(".expand-others").click(function(){a("#otherLockss").slideToggle("fast")});"1"==a("#isPLNPluginInstalled").val()&&a("#otherLockss").hide()};a.pkp.classes.Helper.inherits(a.pkp.controllers.tab.settings.archiving.form.ArchivingSettingsFormHandler,a.pkp.controllers.form.AjaxFormHandler)})(jQuery);(function(a){a.pkp.controllers.tab.settings.permissions=a.pkp.controllers.tab.settings.permissions||{form:{}};a.pkp.controllers.tab.settings.permissions.form.PermissionSettingsFormHandler=function(c,b){this.parent(c,b);a("#licenseURLSelect",c).change(this.callbackWrapper(this.licenseURLSelectChange));a('input[id^="licenseURL-"]',c).keyup(this.callbackWrapper(this.licenseURLOtherChange));a('input[id^="copyrightHolderType-"]',c).change(this.callbackWrapper(this.copyrightHolderRadioSelect));a("#resetPermissionsButton",
...
function(c){c?a('[id^="allow"]').attr("checked","checked"):a('[id^="allow"]').removeAttr("checked")}})(jQuery);(function(a){a.pkp.controllers.tab.workflow=a.pkp.controllers.tab.workflow||{};a.pkp.controllers.tab.workflow.WorkflowTabHandler=function(a,b){var d,e,f,h;this.parent(a,b);if(d=document.location.toString().match("workflow/([^/]+)/")){d=d[1];h=a.find("li a");for(f=0;f<h.length;f++)e=RegExp(d),h[f].getAttribute("class").match(e)&&(b.selected=f)}};a.pkp.classes.Helper.inherits(a.pkp.controllers.tab.workflow.WorkflowTabHandler,a.pkp.controllers.TabHandler)})(jQuery);jQuery.pkp.controllers.informationCenter=jQuery.pkp.controllers.informationCenter||{};
...
a.pkp.controllers.grid.CategoryGridHandler)})(jQuery);(function(a){a.pkp.controllers.grid.users.stageParticipant.form=a.pkp.controllers.grid.users.stageParticipant.form||{};a.pkp.controllers.grid.users.stageParticipant.form.StageParticipantNotifyHandler=function(c,b){this.parent(c,b);b.templateUrl&&(this.templateUrl_=b.templateUrl);b.possibleRecommendOnlyUserGroupIds&&(this.possibleRecommendOnlyUserGroupIds_=b.possibleRecommendOnlyUserGroupIds);b.recommendOnlyUserGroupIds&&(this.recommendOnlyUserGroupIds_=b.recommendOnlyUserGroupIds);b.blindReviewerIds&&
(this.blindReviewerIds_=b.blindReviewerIds);b.blindReviewerWarning&&(this.blindReviewerWarning_=b.blindReviewerWarning);b.blindReviewerWarningOk&&(this.blindReviewerWarningOk_=b.blindReviewerWarningOk);a("input[name='userGroupId'], input[name='userIdSelected']",c).change(this.callbackWrapper(this.updateRecommendOnly));a("input[name='userIdSelected']",c).change(this.callbackWrapper(this.maybeTriggerReviewerWarning));c.find("#template").change(this.callbackWrapper(this.selectTemplateHandler_))};a.pkp.classes.Helper.inherits(a.pkp.controllers.grid.users.stageParticipant.form.StageParticipantNotifyHandler,
...
a.pkp.controllers.grid.users.stageParticipant.form.StageParticipantNotifyHandler.prototype.selectTemplateHandler_=function(){var c=this.getHtmlElement();a.post(this.templateUrl_,c.find("#template").serialize(),this.callbackWrapper(this.updateTemplate),"json")};a.pkp.controllers.grid.users.stageParticipant.form.StageParticipantNotifyHandler.prototype.updateTemplate=function(a,b){var d=this.getHtmlElement(),e=this.handleJson(b),f=b.content,d=d.find('textarea[name="message"]'),h=tinyMCE.EditorManager.get(d.attr("id"));
...
a(c).prop("name")&&!b.is(":visible"))for(c=0;c<this.possibleRecommendOnlyUserGroupIds_.length;c++)if(this.possibleRecommendOnlyUserGroupIds_[c]==d){e.removeAttr("disabled");b.show();for(c=0;c<this.recommendOnlyUserGroupIds_.length;c++)if(this.recommendOnlyUserGroupIds_[c]==d){e.prop("checked",!0);break}break}};a.pkp.controllers.grid.users.stageParticipant.form.StageParticipantNotifyHandler.prototype.maybeTriggerReviewerWarning=function(c){if((c=a(c).val())&&!(0>this.blindReviewerIds_.indexOf(c)))c=
{title:"",okButton:this.blindReviewerWarningOk_,cancelButton:!1,dialogText:this.blindReviewerWarning_},a('<div id="'+a.pkp.classes.Helper.uuid()+'" class="pkp_modal pkpModalWrapper" tabindex="-1"></div>').pkpHandler("$.pkp.controllers.modal.ConfirmationModalHandler",c)};a.pkp.controllers.grid.users.stageParticipant.form.StageParticipantNotifyHandler.prototype.handleResponse=function(c,b){var d=a("#queriesGrid .pkp_controllers_grid");a.pkp.classes.Handler.hasHandler(d)&&a.pkp.classes.Handler.getHandler(d).trigger("dataChanged");
return this.parent("handleResponse",c,b)}})(jQuery);(function(a){a.pkp.controllers.grid.users.stageParticipant.form.AddParticipantFormHandler=function(c,b){this.parent(c,b);a("select[name^='filterUserGroupId']",c).change(this.callbackWrapper(this.addUserGroupId));a("input[name='userId']").click(function(){var b=a("input[name='userId']:checked").val();a("input[name='userIdSelected']").val(b).trigger("change")});this.addUserGroupId()};a.pkp.classes.Helper.inherits(a.pkp.controllers.grid.users.stageParticipant.form.AddParticipantFormHandler,a.pkp.controllers.form.ClientFormHandler);
...
a.pkp.classes.Helper.inherits(a.pkp.controllers.tab.issueEntry.IssueEntryTabHandler,a.pkp.controllers.TabHandler);a.pkp.controllers.tab.issueEntry.IssueEntryTabHandler.prototype.tabContentUrl_=null;a.pkp.controllers.tab.issueEntry.IssueEntryTabHandler.prototype.gridRefreshRequested=function(c,b){a(b.target).attr("id").match(/^galleysGridContainer/)&&(this.tabsUrl_&&this.tabContentUrl_)&&(this.getHtmlElement(),a.get(this.tabsUrl_,null,this.callbackWrapper(this.updateTabsHandler_),"json"))};a.pkp.controllers.tab.issueEntry.IssueEntryTabHandler.prototype.updateTabsHandler_=
function(a,b){var d=this.handleJson(b),e=this.getHtmlElement(),f=e.find("li a"),h={},i=/galley(\d+)/,j,k,n;for(k=0;k<f.length;k++)n=f[k].getAttribute("id"),n=i.exec(n),null!==n&&(h[n[1]]=k);for(j in d.galleys)h.hasOwnProperty(j)||(f=this.tabContentUrl_+"&galleyId="+encodeURIComponent(j),f=f.replace(/[$]/g,"$$$$"),e.tabs("add",f,d.galleys[j]),e.find("li a").filter(":last").attr("id","galley"+j));for(j in h)d.galleys.hasOwnProperty(j)?e.find("li a").filter('[id="galley'+j+'"]').html(d.galleys[j]):e.tabs("remove",
h[j])};a.pkp.controllers.tab.issueEntry.IssueEntryTabHandler.prototype.addGalleysGridRowActionHandlers_=function(){var c=a('[id^="galleysGridContainer"]',this.getHtmlElement());c.length&&(c=a('a[id*="galleyTab"]',c),c.click(this.callbackWrapper(this.galleysGridLinkClickHandler_)))};a.pkp.controllers.tab.issueEntry.IssueEntryTabHandler.prototype.galleysGridLinkClickHandler_=function(c){var b=a('[id^="galleysGridContainer"]',this.getHtmlElement()).children("div"),b=a.pkp.classes.Handler.getHandler(b),
