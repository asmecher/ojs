...
{/if}
	<tr>
		<td class="label">{fieldLabel name="title" required="true" key="plugins.generic.booksForReview.editor.form.title"}</td>
		<td class="value"><input type="text" name="title[{$formLocale|escape}]" id="title" value="{$title[$formLocale]|escape}" size="60" maxlength="255" class="textField" /></td>
	</tr>
	<tr>
...
<table class="data">
	...
	{foreachelse}
	<tr>
		<td class="label">{fieldLabel name="authors-0-firstName" required="true" key="user.firstName"}
...
<table class="data">
	<tr>
		<td class="label">&nbsp;</td>
		<td class="value"><input type="submit" class="button" name="addAuthor" value="{translate key="plugins.generic.booksForReview.editor.form.addAuthor"}" /></td>
	</tr>
	<tr>
		<td colspan="2">&nbsp;</td>
	</tr>
...
<table class="data">
	<tr>
		<td class="label">{fieldLabel name="publisher" required="true" key="plugins.generic.booksForReview.editor.form.publisher"}</td>
		<td class="value"><input type="text" name="publisher" id="publisher" value="{$publisher|escape}" size="60" maxlength="255" class="textField" /></td>
	</tr>
	<tr>
	...
	<tr>
		<td class="label">{fieldLabel name="pages" key="plugins.generic.booksForReview.editor.form.pages"}</td>
		<td class="value"><input type="text" name="pages" id="pages" value="{$pages|escape}" size="5" maxlength="4" class="textField" /></td>
	</tr>
	<tr>
		<td class="label">{fieldLabel name="isbn" key="plugins.generic.booksForReview.editor.form.isbn"}</td>
		<td class="value"><input type="text" name="isbn" id="isbn" value="{$isbn|escape}" size="60" maxlength="30" class="textField" /></td>
	</tr>
	<tr>
		<td class="label">{fieldLabel name="url" key="plugins.generic.booksForReview.editor.form.url"}</td>
		<td class="value"><input type="text" name="url" id="url" value="{$url|escape}" size="60" maxlength="255" class="textField" /></td>
	</tr>
	<tr>
	...
	{if $bookId}
		<tr>
			<td>&nbsp;</td>
			<td><a href="{url op="deleteBookForReview" path=$bookId returnPage=$returnPage}" onclick="return confirm('{translate|escape:"jsparam" key="plugins.generic.booksForReview.editor.confirmDelete"}')" class="action">{translate key="plugins.generic.booksForReview.editor.delete"}</a></td>
		</tr>
	{/if}
</table>
...
<table class="data">
	<tr>
		<td class="label">{fieldLabel name="coverPage" key="plugins.generic.booksForReview.editor.form.image"}</td>
...
<table class="data">
	<tr>
		<td class="label">{translate key="plugins.generic.booksForReview.editor.form.status"}</td>
		<td class="value">{$validStatus[$status]|escape}</td>
	</tr>
	{if $status != $smarty.const.BFR_STATUS_AVAILABLE}
	<tr>
		<td class="label">{translate key="plugins.generic.booksForReview.editor.form.dateRequested"}</td>
		<td class="value">{$dateRequested|date_format:$dateFormatShort}</td>
	</tr>
	{/if}
	{if $status != $smarty.const.BFR_STATUS_AVAILABLE && $status != $smarty.const.BFR_STATUS_REQUESTED}
		<tr>
			<td class="label">{translate key="plugins.generic.booksForReview.editor.form.dateAssigned"}</td>
			<td class="value">{$dateAssigned|date_format:$dateFormatShort}</td>
		</tr>
	{/if}
	{if $status == $smarty.const.BFR_STATUS_MAILED || $status == $smarty.const.BFR_STATUS_SUBMITTED}
		<tr>
			<td class="label">{fieldLabel name="dateMailed" key="plugins.generic.booksForReview.editor.form.dateMailed"}</td>
			<td class="value">{$dateMailed|date_format:$dateFormatShort}</td>
		</tr>
	{/if}
	{if $status != $smarty.const.BFR_STATUS_AVAILABLE && $status != $smarty.const.BFR_STATUS_REQUESTED}
		<tr>
	...
	{if $status == $smarty.const.BFR_STATUS_SUBMITTED}
		<tr>
			<td class="label">{fieldLabel name="dateSubmitted" key="plugins.generic.booksForReview.editor.form.dateSubmitted"}</td>
			<td class="value">{$dateSubmitted|date_format:$dateFormatShort}</td>
		</tr>
	{/if}
	<tr>
		<td class="label">{fieldLabel name="userId" key="plugins.generic.booksForReview.editor.form.user"}</td>
		<td class="value">
		{if $userId}
...
<table class="data">
	<tr>
		<td class="label">{fieldLabel name="articleId" key="plugins.generic.booksForReview.editor.form.article"}</td>
		<td class="value">
			{if $articleId}
...
<table class="data">
<tr>
	<td class="label">{fieldLabel name="notes" key="plugins.generic.booksForReview.editor.form.notes"}</td>
	<td class="value"><textarea name="notes" id="notes" cols="60" rows="6" class="textArea richContent">{$notes|escape}</textarea></td>
</tr>
</table>
</div>
