...
<script>
	$(function() {ldelim}
		...
		$('#subscriptionType').pkpHandler('$.pkp.controllers.form.FormHandler');
	{rdelim});
</script>
...
{/if}
<tr>
	<td class="label">{fieldLabel name="name" required="true" key="manager.subscriptionTypes.form.typeName"}</td>
