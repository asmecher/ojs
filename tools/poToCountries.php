...
<!--
  * ' . $ofn . '
  *
  * Copyright (c) 2014-' . date('Y') . ' Simon Fraser University Library
  * Copyright (c) 2000-' . date('Y') . ' John Willinsky
  * Distributed under the GNU GPL v2. For full terms see the file docs/COPYING.
  *
...
');
		foreach ($outputMap as $code => $translation) {
			$translation = htmlspecialchars($translation, ENT_NOQUOTES | ENT_XML1, 'UTF-8');
